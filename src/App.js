...
const ADMIN_PASSWORD = "scentlab2025";
...
export default function App() {
  ...
  const essenceList = gender === "dama" ? ESSENCES_DAMA : ESSENCES_CABALLERO;
  const allEssences = [...ESSENCES_DAMA, ...ESSENCES_CABALLERO];
                    ...
                    {allEssences.map(e => (
                      <div key={e} className="card" style={{ padding: "18px 18px 16px", opacity: essenceStock[e] ? 1 : 0.5 }}>
                        ...
                        <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: 2, color: C.textFaint, marginBottom: 6, textTransform: "uppercase" }}>
                          {ESSENCES_DAMA.includes(e) ? "Dama" : "Caballero"}
                        </div>
                ...
                {adminTab === "stock" && (
                  <div className="fu">
                    ...
                    <div style={{ marginBottom: 28 }}>
                      ...
                      {Object.keys(essenceStock).filter(e => ESSENCES_DAMA.includes(e) || (!ESSENCES_CABALLERO.includes(e) && !ESSENCES_DAMA.includes(e))).filter(e => !ESSENCES_CABALLERO.includes(e)).map(e => (
